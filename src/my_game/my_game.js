...
class MyGame extends engine.Scene {
    ...
    load() {
        engine.texture.load(this.kBullet); // loading texture of a projectile
        // engine.texture.load(this.kTrail); // loading a trail for a projectile
    ...
    init() {
        this.mProjectile = new Projectile(this.kBullet, 120);
        this.mProjectile.getXform().setSize(20, 20);
        this.mProjectile.getXform().setPosition(10, 8)
        // this.mProjectile.setStraight(this.mCamera.getWCCenter(), 0.5, 0.2);
    ...
    draw() {
        ...
        this.mProjectile.draw(this.mCamera);
